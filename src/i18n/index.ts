...
const en: Translations = {
  ...
  errorHint: 'Make sure the transaction digest is valid and from Sui mainnet.',
  errorTipsTitle: 'Tips:',
  tipWait: 'Wait a few seconds and try again',
  tipNetwork: 'The Sui network might be experiencing high load',
  tipCheck: 'Check if the transaction ID is correct',
  inputPlaceholder: 'Paste a transaction hash or a full explorer URL from SuiScan, SuiVision, or Sui Explorer',
  inputEmptyError: 'Please paste a Sui transaction ID or a supported explorer URL.',
  inputUrlError: 'That link is not a valid URL.',
  inputHostError: 'Only SuiScan, SuiVision, and Sui Explorer transaction URLs are supported.',
  inputNotTxError: 'This URL does not look like a Sui transaction page. Paste a transaction link or ID.',
...
const ptBR: Translations = {
  ...
  errorHint: 'Verifique se o identificador da transação é válido e pertence à rede principal do Sui.',
  errorTipsTitle: 'Dicas:',
  tipWait: 'Aguarde alguns segundos e tente novamente',
  tipNetwork: 'A rede Sui pode estar sobrecarregada',
  tipCheck: 'Confirme se o ID da transação está correto',
  inputPlaceholder: 'Cole um hash de transação ou URL do SuiScan, SuiVision ou Sui Explorer',
  inputEmptyError: 'Cole um ID de transação Sui ou uma URL de explorador suportada.',
  inputUrlError: 'Este link não é uma URL válida.',
  inputHostError: 'Apenas URLs do SuiScan, SuiVision e Sui Explorer são suportadas.',
  inputNotTxError: 'Esta URL não parece uma página de transação Sui. Cole um link ou ID de transação.',
...
const es: Translations = {
  ...
  errorHint: 'Asegúrate de que el identificador de transacción sea válido y de la red principal de Sui.',
  errorTipsTitle: 'Consejos:',
  tipWait: 'Espera unos segundos e intenta de nuevo',
  tipNetwork: 'La red Sui puede estar experimentando alta carga',
  tipCheck: 'Verifica que el ID de transacción sea correcto',
  inputPlaceholder: 'Pega un hash de transacción o URL de SuiScan, SuiVision o Sui Explorer',
  inputEmptyError: 'Pega un ID de transacción Sui o una URL de explorador compatible.',
  inputUrlError: 'Este enlace no es una URL válida.',
  inputHostError: 'Solo se admiten URLs de SuiScan, SuiVision y Sui Explorer.',
  inputNotTxError: 'Esta URL no parece una página de transacción Sui. Pega un enlace o ID de transacción.',
